...
.controller('AddController', ['$rootScope', '$scope', 'FORM_REQUIRED', function($rootScope, $scope, FORM_REQUIRED) {
...
.controller('ViewController', ['$rootScope', '$scope', '$window', '$element', 'users', function($rootScope, $scope, $window, $element, users) {
	$scope.users = [];
	$scope.uid = -1;
	$scope.countObject
	...
	$element.find('table').on('click', 'button', function(event) {
		...
		$rootScope.$broadcast('getUser', searchById($scope.uid));
	});
